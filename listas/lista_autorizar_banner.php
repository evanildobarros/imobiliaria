...
?>
			...
			<form name="form2" method="post" action="layout_autorizar_banner.php">
			<label>
			...
			<span class="span7">&nbsp; &nbsp; &nbsp;Autorizar publica&ccedil;&atilde;o de Banner</span>
			</form>
			</td>
			</tr>
			</table>
			...
			$sql = "SELECT *
FROM cliente AS cli
WHERE cli.id_cliente AND cli.autorizar='2' AND cli.cliente like '".$filtro."%' ORDER BY cli.id_cliente DESC LIMIT $inicio, $qnt";
			...
			<td width="103" valign="middle" class="td3"><div align="center"><a href="#" onclick="MM_openBrWindow('autorizar_banner.php?id_cliente=<?php echo $resultado['id_cliente']; ?>','','scrollbars=yes,resizable=yes,width=300,height=180')">Autorizar</a></div></td>
			</tr>
			<tr><?php $cont ++; }?>
			<?php
			...
			echo "<a class=\"pag\" href='layout_autorizar_banner.php?p=1' target='_self'><span class=\"\">&laquo; Anterior</span></a> ";
			...
			echo "<a class=\"pag\" href='layout_autorizar_banner.php?p=".$i."' target='_self'>".$i."</a> ";
			}
			}
			...
			echo "<a class=\"pag\" href='layout_autorizar_banner.php?p= " .$pags."' target='_self'><span class=\"\">Pr&oacute;xima &raquo;</span></a> ";
