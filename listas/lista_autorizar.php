...
?>
			...
			$sql = "SELECT im.int_id, cli.capa, cli.cliente, cli.email, cli.telefone, im.autorizar
FROM cliente AS cli, imovel AS im
WHERE cli.id_cliente = im.id_cliente AND im.autorizar= '2' AND cli.cliente like '".$filtro."%' ORDER BY cli.id_cliente DESC LIMIT $inicio, $qnt";
