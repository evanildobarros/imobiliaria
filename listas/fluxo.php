...
<table width="1000" border="0" align="center" style="border-collapse:collapse;">
  <tr>
    <td width="222" colspan="3" bgcolor="#F4F4F4"><div style="padding:5px;  margin:0px 0px 0px 35px;"><img src="../img/LOGO_CARRO3.png" alt="" width="175" height="80" /></div></td>
    <td width="451" bgcolor="#F4F4F4"><div align="center" style="color:#FF3300; font-family:Arial, Helvetica, sans-serif; font-weight:bold; font-size:18px;"><br />
          <br />
