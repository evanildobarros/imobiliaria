...
<table width="1000" border="0" align="center" style="border-collapse:collapse;">
			...
			<form name="form2" method="post" action="layout_vistoria.php">
			<label>
			...
			<span class="span7">&nbsp; &nbsp; &nbsp;ficha de vistoria</span>
			</form>
			</td>
			</tr>
			</table>
			...
			$sql = "SELECT DISTINCT id_cliente,cliente,telefone,email,municipio from cliente WHERE cliente like '".$filtro."%' AND cpf_titular like '".$filtro1."%' ORDER BY id_cliente DESC LIMIT $inicio, $qnt ";
        ...
        <input type="checkbox" name="chkDel[]" value="<?php echo $resultado["id_cliente"];?>">
        </label>          <span class="span6"><?php echo $resultado['cliente']; ?></span></td>
        <td valign="top"><span class="span6"><?php echo $resultado['telefone']; ?></span></td>
        <td valign="top"><span class="span6"><?php echo $resultado['email']; ?></td></td>
        <td valign="top"><span ><a class="span10" href="ficha_vistoria.php?id_cliente=<?php echo $resultado['id_cliente']; ?>">Ficha de Vistoria</a></span></td>
        </tr>
        <tr><?php $cont ++; }?>
			<?php
			...
			echo "<a class=\"pag\" href='layout_vistoria.php?p=1' target='_self'><span class=\"\">&laquo; Anterior</span></a> ";
			...
			echo "<a class=\"pag\" href='layout_vistoria.php?p=".$i."' target='_self'>".$i."</a> ";
			}
			}
			...
			echo "<a class=\"pag\" href='layout_vistoria.php?p= " .$pags."' target='_self'><span class=\"\">Pr&oacute;xima &raquo;</span></a> ";
