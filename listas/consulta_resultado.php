...
mysql_select_db($database_conexao, $conexao);
$query_movei = sprintf("SELECT * FROM lc_movimento WHERE mes LIKE%s AND tipo LIKE%s ORDER BY id DESC", GetSQLValueString("%" . $colname_movei . "%", "text"),GetSQLValueString("%" . $colname1_movei . "%", "text"));
...
mysql_select_db($database_conexao, $conexao);
$query_con2 = sprintf("SELECT * FROM lc_movimento WHERE mes LIKE %s ORDER BY id DESC", GetSQLValueString("%" . $colname_con2 . "%", "text"));
...
mysql_select_db($database_conexao, $conexao);
$query_con3 = sprintf("SELECT * FROM lc_movimento WHERE mes LIKE%s AND tipo LIKE%s ORDER BY id DESC", GetSQLValueString("%" . $colname_con3 . "%", "text"),GetSQLValueString("%" . $colname1_con3 . "%", "text"));
...
mysql_select_db($database_conexao, $conexao);
$query_soma1 = "SELECT SUM(valor) as total FROM lc_movimento WHERE tipo=1";
...
mysql_select_db($database_conexao, $conexao);
$query_soma2 = "SELECT SUM(valor) as total FROM lc_movimento WHERE tipo=0";
...
mysql_select_db($database_conexao, $conexao);
$query_total_s = sprintf("SELECT SUM(valor) as total FROM lc_movimento WHERE tipo LIKE %s AND mes LIKE %s ", GetSQLValueString("%" . $colname_total_s . "%", "text"),GetSQLValueString("%" . $colname1_total_s . "%", "text"));
...
<table width="1027" border="0" align="center">
  <tr>
    <td width="352" valign="top" bgcolor="#FFFFFF"><img src="../img/LOGO_CARRO2.jpg" width="500" height="80" /></td>
    ...
    <td width="209" valign="top" bgcolor="#FFFFFF"><div align="right"><span class="style3">N&ordm; <?php echo date("md"); ?><?php echo $row_con2['id']; ?></span></div></td>
  </tr>
</table>
<p>&nbsp;</p>
<hr>
...
<table width="1027" border="0" align="center">
  ...
  <?php do { ?>
  <tr>
    <td bgcolor="#FFFFFF"><?php if ($row_con3['tipo']==1) echo "<font color=\"#000099\"><strong>RECEITA</strong></font>"; else echo "<font color=\"Red\"><strong>DESPESAS</strong></font>"?>    </td>
  </tr>
...
<table width="1027" border="0" align="center">
  <tr>
    <td width="245" valign="top" bgcolor="#FFFFFF"><span class="style6">DATA DA MOVIMENTA&Ccedil;&Atilde;O</span></td>
<td width="225" valign="top" bgcolor="#FFFFFF"><span class="style6">CATEGORIA<br />
          <br />
    </span></td>
    <td width="268" valign="top" bgcolor="#FFFFFF"><span class="style6">SERVI&Ccedil;O</span></td>
    <td width="113" valign="top" bgcolor="#FFFFFF"><span class="style6">VALOR</span></td>
  </tr>
  <?php 
   $cont = 0;
   do 
  ...
  <tr bgcolor="<?php echo $cor ; ?>">
    ...
    <td valign="top" bgcolor="#FFFFFF" class="style11"><?php echo $row_movei['servico']; ?></td>
