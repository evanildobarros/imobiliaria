...
?>
			...
			<td valign="top" class=""><font color="#999999"><?php echo $resultado['cliente']; ?></td>
			...
			<td valign="top"><div align="center"><a href="#" onclick="MM_openBrWindow('editar_aluno.php?id_aluno=<?php echo $resultado['id_cliente']  ?>','','scrollbars=yes,resizable=yes,width=400,height=500')">Atualizar</a></div></td>
			</tr>
			<tr><?php $cont ++; }?>
			<?php
