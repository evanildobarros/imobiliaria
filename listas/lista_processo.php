...
@session_start();
		require'../Connections/conexao.php';	
			...
			<form name="form2" method="post" action="layout_processo.php">
			<label>
			...
			$sql = "SELECT DISTINCT cliente from processo WHERE cliente like '".$filtro."%' ORDER BY id_processo DESC LIMIT $inicio, $qnt ";
		...
		<tr bgcolor="<?php echo $cor ; ?>">
          ...
          <a href="#" class="span11" onclick="MM_openBrWindow('movimentacao.php?cliente=<?php echo $resultado['cliente']; ?>','','scrollbars=yes,resizable=yes,width=500,height=300')">movimentar</a></div></td>
			...
			echo "<a class=\"pag\" href='layout_processo.php?p=1' target='_self'><span class=\"\">&laquo; Anterior</span></a> ";
			...
			echo "<a class=\"pag\" href='layout_processo.php?p=".$i."' target='_self'>".$i."</a> ";
			}
			}
			...
			echo "<a class=\"pag\" href='layout_processo.php?p= " .$pags."' target='_self'><span class=\"\">Pr&oacute;xima &raquo;</span></a> ";
