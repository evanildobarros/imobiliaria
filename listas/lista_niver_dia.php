...
@session_start();
		require'../Connections/conexao.php';	
			...
			<form name="form2" method="post" action="layout_niver_dia.php">
			<label>
			...
			$filtro1 = $_REQUEST['filtro1'];
			   ...
			   $sql = "SELECT DISTINCT cliente,telefone,email,aniversario,(DAY(CURDATE()) = DAY(aniversario)) as niver
    ...
    <td class="td3" valign="top"><span class="span6"><?php 
	   $date = $resultado['aniversario']; 
...
<tr><?php $cont ++; }?>
			...
			echo "<a class=\"pag\" href='layout_niver_dia.php?p=1' target='_self'><span class=\"\">&laquo; Anterior</span></a> ";
			...
			echo "<a class=\"pag\" href='layout_niver_dia.php?p=".$i."' target='_self'>".$i."</a> ";
			}
			}
			...
			echo "<a class=\"pag\" href='layout_niver_dia.php?p= " .$pags."' target='_self'><span class=\"\">Pr&oacute;xima &raquo;</span></a> ";
