...
<br />
    ...
    <table cellpadding="1" cellspacing="10"  width="900" align="center" style="background-color:#3b5998;">
...
for ($i=1;$i<=12;$i++){
    ...
    <?php if($mes_hoje==$i){?>    
    color:#00CCFF; font-size:16px; font-weight:bold; padding:5px; text-decoration:none; font-family:Arial, Helvetica, sans-serif;
    <?php }else{?>
    color:#FFF; font-size:16px; text-decoration:none; font-family:Arial, Helvetica, sans-serif;
    <?php }?>
    ">
