...
-->
			...
			<span class="span7">
			Editar e Excluir Clientes			</span>
			</form>
			</td>
			</tr>
			</table>
			...
			$sql = "SELECT * from cliente WHERE cliente like '".$filtro."%' ORDER BY id_cliente DESC ";
			...
			<td width="251" valign="top" class=""><font color="#999999"><?php echo $resultado['cliente']; ?></td>
			...
			<td valign="top"><div align="center"><a class="span8" href="#" onclick="MM_openBrWindow('atualisar_cli.php?id_cliente=<?php echo $resultado['id_cliente']  ?>','','scrollbars=yes,resizable=yes,width=400,height=500')">Atualizar</a></div></td>
			</tr>
			<tr><?php $cont ++; }?>
			<?php
