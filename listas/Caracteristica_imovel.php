...
<div class="t_1"><span style="color:#666666">&equiv; Detalhes do Im&oacute;vel </span></div>
<div class="t_2">
...
<?php echo $desc ?></div>
<div class="t_4">&equiv; Galeria </div>
...
<div class="t_6"><span style="color:#FFFFFF">&plusmn; Localiza&ccedil;&atilde;o</span></div>

<div class="t_5">

<?php 
$sql2 = mysql_query("SELECT * FROM cliente AS cli, galeria AS gal WHERE cli.id_cliente = gal.id_cliente AND cli.id_cliente ='$id' limit 14"); 
...
<div class="cont_gale">
            ...
            <a href="galeria.php?id=<?php echo $res['id']; ?>"><img style="background:#F8F8F8; 
            border-right:1px solid #ddd; 
            border-bottom:1px solid #ddd; 
            padding:5px;" 
            width="100" height="80" src="../uploads/<?php echo $capa ?>"/></a>
