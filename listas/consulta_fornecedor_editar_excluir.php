...
-->
			...
			<tr>
			<td>
			<form name="form2" method="post" action="layout_fo_excluir.php">
			<label>
			...
			<td width="82"></tr>
			<tr>
			<td colspan="6">Selecionar Todos</td>
			</tr>
			...
			$sql = "SELECT * from fornecedor WHERE nome like '".$filtro."%' ORDER BY id_fornecedor DESC ";
			...
			<td width="251" valign="top" class=""><font color="#999999"><?php echo $resultado['nome']; ?></td>
			...
			<td valign="top"><font color="#999999"><?php echo $resultado['email']; ?></td>
			<td valign="top"><div align="center"><a class="span8" href="#" onclick="MM_openBrWindow('atualisar_for.php?id_fornecedor=<?php echo $resultado['id_fornecedor']  ?>','','scrollbars=yes,resizable=yes,width=400,height=300')">Atualizar</a></div></td>
			</tr>
			<tr><?php $cont ++; }?>
			<?php
			...
			echo "<a class=\"pag\" href='layout_fo_excluir.php?p=1' target='_self'><span class=\"\">&laquo; Anterior</span></a> ";
			...
			echo "<a class=\"pag\" href='layout_fo_excluir.php?p=".$i."' target='_self'>".$i."</a> ";
			}
			}
			...
			echo "<a class=\"pag\" href='layout_fo_excluir.php?p= " .$pags."' target='_self'><span class=\"\">Pr&oacute;xima &raquo;</span></a> ";
