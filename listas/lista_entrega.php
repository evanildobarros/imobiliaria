...
@session_start();
		require'../Connections/conexao.php';	
			...
			$sql = "SELECT DISTINCT id_cliente, cliente,telefone,email,cpf_titular,status,status2 from cliente WHERE cliente like '".$filtro."%' ORDER BY id_cliente DESC LIMIT $inicio, $qnt ";
