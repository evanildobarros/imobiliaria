...
@session_start();
		require'../Connections/conexao.php';	
			...
			<form name="form2" method="post" action="layout_imovel_lista.php">
			<label>
			...
			<span class="span7">&nbsp; &nbsp; &nbsp;registrar novo im&oacute;vel</span>
			</form>
			</td>
			</tr>
			</table>
    ...
    <td valign="top" class="td3"><div align="center"><a href="layout_imovel.php?id_cliente=<?php echo $resultado['id_cliente'] ?>">Imovel</a></div></td>
    </tr>
<tr><?php $cont ++; }?>
			<?php
			...
			echo "<a class=\"pag\" href='layout_imovel_lista.php?p=1' target='_self'><span class=\"\">&laquo; Anterior</span></a> ";
			...
			echo "<a class=\"pag\" href='layout_imovel_lista.php?p=".$i."' target='_self'>".$i."</a> ";
			}
			}
			...
			echo "<a class=\"pag\" href='layout_imovel_lista.php?p= " .$pags."' target='_self'><span class=\"\">Pr&oacute;xima &raquo;</span></a> ";
