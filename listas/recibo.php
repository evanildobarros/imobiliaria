...
<table width="700" border="0" align="center" style="border-collapse:collapse; border:1px solid #999999; padding:20px;">
  <tr>
    <td width="190" bgcolor="#F7F7F7"><div style="padding:5px;  margin:0px 0px 0px 35px;"><img src="../img/LOGO_CARRO3.png" width="175" height="80" /></div></td>
    <td width="246" valign="top" bgcolor="#F7F7F7"><div align="center" style="color:#FF3300; font-weight:bold; font-size:18px;"><br />
        <br />
    RECIBO</div></td>
    <td width="246" valign="top" bgcolor="#F7F7F7"><div style="font-family:Arial, Helvetica, sans-serif; font-size:12px;">Av. Jer&ocirc;nimo de Albuquerque Pop Center Bloco C, Sala 08, , Cohab Anil III<br />
...
Recebi <?php echo "do(a) cliente ".$row5['cliente']; ?> <?php echo $row5['fornecedor']; ?> </strong>&nbsp;a import&acirc;ncia <strong>R$</strong>&nbsp;<strong>
<?php
...
<table width="700" border="0" align="center" style="border-collapse:collapse; border:1px solid #999999; padding:20px;">
  <tr>
    <td width="190" bgcolor="#F7F7F7"><div style="padding:5px;  margin:0px 0px 0px 35px;"><img src="../img/LOGO_CARRO3.png" alt="" width="175" height="80" /></div></td>
    <td width="246" valign="top" bgcolor="#F7F7F7"><div align="center" style="color:#FF3300; font-weight:bold; font-size:18px;"><br />
            <br />
      RECIBO</div></td>
    <td width="246" valign="top" bgcolor="#F7F7F7"><div style="font-family:Arial, Helvetica, sans-serif; font-size:12px;">Av. Jer&ocirc;nimo de Albuquerque Pop Center Bloco C, Sala 08, , Cohab Anil III<br />
