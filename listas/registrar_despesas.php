...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO movimento (`data`, cliente, servico, tipo, categoria, valor, status, mes, fornecedor) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
?>
    ...
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Servi&ccedil;o:</td>
