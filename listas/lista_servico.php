...
@session_start();
		require'../Connections/conexao.php';	
			...
			<span class="span7">&nbsp; &nbsp; &nbsp;registrar novo servi&ccedil;o</span>
			</form>
			</td>
			</tr>
			</table>
    ...
    <td valign="top" class="td3"><div align="center"><a href="layout_ad_servico.php?id_cliente=<?php echo $resultado['id_cliente'] ?>"><img src="../img/SERVICO.jpg" /></a></div></td>
    </tr>
<tr><?php $cont ++; }?>
			<?php
