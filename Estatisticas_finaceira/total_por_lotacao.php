...
<table width="1000" border="0" align="center" style="border-collapse:collapse;">
  ...
  <tr>
    <td width="836" bgcolor="#1D76E2"><span style="color:#fff; padding:5px;">Escrit&oacute;rio</span><br /></td>
    <td width="154" bgcolor="#003366"><div align="center" style="color:#fff; margin:0px 0px 0px 20px;">Valor</div></td>
  </tr>
  <?php
  $cont = 0;
...
<table width="1000" border="0" align="center" style="border-collapse:collapse;">
  <tr>
    <td width="835" bgcolor="#1D76E2"><span style="color:#fff; padding:5px;">
      &nbsp;Total<br />
    </span></td>
    <td width="155" bgcolor="#003366"><div align="center"><span style="color:#00CC33; font-weight:bold;">R$
