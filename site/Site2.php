...
$query_imagens = "SELECT * FROM banner where autorizar='1' limit 5";
 ...
 <div id="content">
  ...
  <div id="wowslider-container1">
   ...
   <ul>
    <?php do { ?>
<li>
 <img width="760px" height="300px" src="uploads/<?php echo $row_imagens['img']; ?>" title="<?php echo $row_imagens['descricao']; ?>" />
