...
color:#CC0033;">Total Geral <?php 
			...
			$sql5 = mysql_query("SELECT SUM(valor) as total from lc_movimento WHERE tipo = '0' AND status='1'");
			...
			<tr>
			<td bgcolor="#FFFFFF" class="">
			<form name="form2" method="post" action="contas_a_pagar.php">
			<label>
			...
			<span class="span7">&nbsp; &nbsp; &nbsp;Lan&ccedil;amentos</span>
			</form>			</td>
			</tr>
			</table>
			...
			$filtro1 = $_REQUEST['filtro1'];
			 ...
			 $sql = "SELECT * from lc_movimento as lcm,lc_cat as cat WHERE lcm.cat = cat.id AND lcm.tipo = '0' AND lcm.status='1' AND lcm.cliente like '".$filtro."%' AND lcm.fornecedor like '".$filtro1."%'  ORDER BY lcm.id DESC LIMIT $inicio, $qnt  ";
        ...
        <tr><?php $cont ++; }?>
			...
			echo "<a class=\"pag\" href='contas_a_pagar.php?p=1' target='_self'><span class=\"\">&laquo; Anterior</span></a> ";
			...
			echo "<a class=\"pag\" href='contas_a_pagar.php?p=".$i."' target='_self'>".$i."</a> ";
			}
			}
			...
			echo "<a class=\"pag\" href='contas_a_pagar.php?p= " .$pags."' target='_self'><span class=\"\">Pr&oacute;xima &raquo;</span></a> ";
