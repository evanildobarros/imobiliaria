...
<div class="box_select"><form name="form1" method="POST" action="layout_receber.php">
...
<tr>
        ...
        <td bgcolor="#3B5998"><span class="td" style="font-size:26px; color:<?php if ($s_total2<0) echo "#fd0000"; else echo "#33FF00"?>">R$&nbsp;<?php echo number_format( $s_total2  , 2 , ',' , '.' ); ?></span></td>
    </tr>
  </table>
</div>
