...
<table width="900" border="0" align="center">
  <tr>
    <td width="169"><img src="../img/logo2.png" width="151" height="92" /></td>
    <td width="715" valign="top">O CENTRO DE FORMA&Ccedil;&Atilde;O DE CONDUTORES &quot;&quot;LTDA.., pessoa juridica de direito privado, inscrita no CNPJ<br />
      sob o n&ordm; 030.009./0001-45 com sede na rua 03 qd.05 casa 36 cohatrac IV - S&atilde;o lu&iacute;s - Ma<br />
      credenciado junto ao DETRAN_MA, Portaria n&ordm; ____________ neste ato designado t&atilde;o somente de Auto Escola &quot;&quot;,<br />
    representado pelos seus direitos.</td>
  </tr>
  <tr>
    <td colspan="2"><hr /></td>
  </tr>
...
WHERE tra.aluno = '$nome' ORDER BY tra.id DESC limit 1");
  ...
  $sql2 = mysql_query("SELECT SUM(servic.valor) as total  FROM serv, alunos AS al, servicos AS servic
   ...
   ?>
      ...
      <p>Respons&aacute;vel (Pai, M&atilde;e) CFC MHS Soluções Web</p>
      <p><br />
    </p></td>
  </tr>
  <tr>
